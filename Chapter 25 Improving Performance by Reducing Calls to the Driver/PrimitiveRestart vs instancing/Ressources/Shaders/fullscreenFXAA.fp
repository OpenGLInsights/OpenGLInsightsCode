...
void main()
{
	...
	Color =  FxaaPixelShader(
		...
		/*FxaaFloat4 fxaaConsolePosPos*/			In.fxaa_ConsolePosPos,
		/*FxaaTex tex*/								texToSample,
		/*FxaaTex fxaaConsole360TexExpBiasNegOne*/	texToSample,
		/*FxaaTex fxaaConsole360TexExpBiasNegTwo*/	texToSample,
		...
		/*FxaaFloat fxaaConsoleEdgeSharpness*/		8,
