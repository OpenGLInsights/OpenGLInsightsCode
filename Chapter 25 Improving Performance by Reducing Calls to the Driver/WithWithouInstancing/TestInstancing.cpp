...
void TestInstancing::render(const unsigned int nbInstance, const float* position, const float* mvpMat, const float* mvMat, const float* pMat)
{
	if(position==NULL)
	{
...
void TestInstancing::renderInstancing(const unsigned int nbInstance, const float* position, const float* mvpMat, const float* mvMat, const float* pMat)
{
	if(position==NULL)
	{
		///// render triangle at the same place
